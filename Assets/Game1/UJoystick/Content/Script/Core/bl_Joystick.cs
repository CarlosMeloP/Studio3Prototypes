...
{
    [Header("Reference")]
    [SerializeField]private RectTransform StickRect;//The midle joystick UI
    [Header("Settings")]
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("Requiered at lest one canvas for joystick work.!");
            this.enabled = false;
            return;
        }

        //Get the default area of joystick
        DeathArea = StickRect.position;
    ...
    {
        //If this touch id is the firts touch in the event
    ...
    private float radio { get { return (Radio * 5); } }
